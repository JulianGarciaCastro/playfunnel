  <!---------------------------------------------------Tooltip-->
<div class="toolOptionEdit d-none" id="toolOptionEdit">
	...
	<div class="OptionsEdit">
		...
		<hr class="my-2">   
			...
			<input class="slider-alpha" type="range" min="10" max="100" step="10"  value="10">
		</div> 
		<hr class="my-2">
    				...
    				$.each(arrOpciones, function(j, data) {
						if(data.uuid == $("#optionUuid").val()){
							...
							if(data.type == "URL"){
								...
								if(data.options == '_blank' || data.options == '_parent' || data.options == '_top')
