	...
	<body class="bg-white">
                ...
                <div class="mainContainer col row p-0 m-0">
                    ...
                    <div class="mainContainer col row p-0 m-0">
                        <div class="main col m-0 p-0">
                            ...
                            <div class="previewPanel p-0 m-0 row mt-2">
                                <ul class="devices d-flex m-0 mr-4 p-2 align-items-center d-none">
                                ...
                                <button id="preview-project"
                                 ...
                                 <button id="preview-landing"
                                    onclick="window.location.href='{{ 'https://' . $_SERVER['HTTP_HOST'] . '/landing?project=' . $codigo_proyecto_encriptado . '&preview=true' }}'" 
                                    class="btn-square bg-01 cWhite px-3 ml-0">
                                    {{ __('step4.preview') }}
                                    <i class="far fa-eye ml-2 py-0"></i>
                                </button>
                            </div>
        ...
        <script>
            window.onload = function() {
                ...
                const previewUl = document.querySelector('.previewPanel ul');
                const previewLanding = document.querySelector('#preview-landing');
                ...
                sharePage.addEventListener('click', function() {
                    ...
                    //Preview
                    previewUl.classList.add('d-none');
                    previewLanding.classList.remove('d-none');
                    previewProject.classList.add('d-none');
                ...
                finalView.addEventListener('click', function() {
                    ...
                    //Preview
                    previewUl.classList.remove('d-none');
                    previewLanding.classList.add('d-none');
                    previewProject.classList.remove('d-none');
