            ...
            <div class="content row justify-content-between col-12">
              ...
              <div class="right col align-items-center justify-content-center  mx-0 row">
                <div class="col-12 row justify-content-center px-0">
                  ...
                  {{__('profile.info_abnout')}} <a href="" class="c01 col-12 text-center pt-3 px-0">{{__('profile.service_conditions')}} </a>
                  {{__('profile.or')}} <a href="" class="c01 col-12 text-center px-0">{{__('profile.our_privacy_policy')}}</a>
                  </p>
                 </div>
              </div>
