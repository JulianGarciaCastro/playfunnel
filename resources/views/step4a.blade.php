	...
	<body class="bg-white">
            	...
            	<div class="mainContainer col row p-0 m-0">
                	<div class="main col m-0 p-0">
                    	<div class="steps m-0 p-0 row">
                  		...
                  		<div class="row justify-content-center blockAdd poster desktop d-none" >
                      		<div class="addVideoMain contentIframe {{ $project->aspect }} prev" id="endVideoContent">
                        	@if ($project->publish_div)
                          		{!! $project->publish_div !!}
                        	@else
                          		<div class="poster-end flex-column align-items-center justify-content-center w-100 ">
                                    <button class="edit-poster" onclick="edit_color()"><i class="fas fa-pencil-alt"></i></button>
                                    <div id="resizable" class="resizable ui-widget-content content-image logo p-0 my-3">
                                      <button id='imgGetIn_view'></button>
                                      <img src="{{ $publish_library_img }}" class="img-fluid logoImg" alt="" id="endVideoimage">
                                      <input class="img" type="hidden" id="endVideoimageId" value="{{ $project->publish_library_img }}">
                                    </div>
                                    ...
                                    <button contenteditable  id="again" class="btn-square bg-Main cWhite px-3 mt-3">{{ __('step4.play_again') }}</button>
                    			</div>
                        	@endif
                      	</div>
                  	</div>
                  		...
                  		@else
                          	<div class="landing dark w-100 h-100 py-5" >                      
                              	<div class="w-50 content-data">
                                    ...
                                    <h1 class="my-4" contenteditable>Lorem, ipsum dolor sit amet consectetur adipisicing elit</h1>
                                    ...
                                    <?php
                                        ...
                                        echo '<iframe src="http://' . $_SERVER['HTTP_HOST'] . '/embed?project=' . $codigo_proyecto_encriptado . '" allow="camera *; microphone *; autoplay *; encrypted-media *; fullscreen *; display-capture *;" style="  position: absolute; top:0; left: 0; width: 100%;  height: 100%; border: none;"></iframe>'
                                    ?>  
                                    </div>
                                    <div class="context wysiwyg-content">
                                        <p contenteditable data-desktop="18" class="justify-content-center my-3" id="subtile-land">{{__('step4.title1')}}</p>
                                    </div>
                ...
                <div class="col-12 col-lg-4 bg-white p-0 m-0 rightMenu setup4 mt-md-0 mt-5">
                    ...
                    <div class="p-3 p-lg-4 mb-5 publishPanel">
                        ...
                        <div class="viewPanel d-flex p-0 bg-05 align-items-center justify-content-between m-0">
                            <a id="share_page" class="py-3 col text-center active">Share Page</a>
                            <a id="final_view" class="py-3 col text-center">Final View</a>
                        </div>
                        <hr class="my-2">
                                    ...
                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                        <div class="card-body py-3 px-2">
                                            ...
                                            <p class="linkBox p-2 m-0" id="iframeLink">
                                                <?php
                                                    echo htmlentities('<div class="embed-container" style=" position: relative; padding-bottom:' . $aspect . '; height: 0; overflow: hidden; border:none; border-radius: 24px"> 
                                            ...
                                            <div class="cta pt-3">
                                            	<button id="copyIframe" class="btn-square bg-Main cWhite px-3">{{ __('step4.copy') }}☍</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                                        <div class="card-body py-3 px-2">
                                            ...
                                            <div class="cta pt-3">
                                            	<button id="copyUrl" class="btn-square bg-Main cWhite px-3">{{ __('step4.copy') }}☍ </button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 next d-flex justify-content-center">
                            <button class="btn-square bg-Main cWhite px-3">
                            	<i class="fas fa-caret-square-right mr-2"></i>{{ __('step4.publish') }}
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class="toolOptionEdit d-none" draggable="true" id="toolOptionEdit">
            ...
            <div class="OptionsEdit">
                ...
                <div class="name d-flex  justify-content-betwee align-items-center w-100">
                    <input class="px-2 col text-left" type="text" id="cta-poster" placeholder="Nombre de la opción">
                </div>
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="col-12">
                        ...
                        <p class="text-center pb-2 c02" id="modalContent">Â¿Estas seguro que deseas desvincular el medio del proyecto?</p>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Función para manejar el clic en share_page
                ...
                // Función para manejar el clic en final_view
            ...
            function copyToClipBoard(type) {
                if (type == "iframe") {
                    ...
                    modalMsgShow("IFrame copiada al clipboard");
                } else if (type == "url") {
                    $("#UrlLink").text();
                    navigator.clipboard.writeText($("#UrlLink").text());
                    modalMsgShow("URL copiada al clipboard");
                }
            }
    
            function boton_guardar() {
                console.log("boton_guardar(): línea <?= __LINE__ - 1 ?>");
                ...
                form.append('landing_page', $('#landing_page').html());
				//alert("contenido: " + $('#landing_page').html());
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.success == 'N') {
                                //alert("Error: " + response.message + "Linea <?= __LINE__ - 1 ?>" );
                        ...
                        error: function(request, error) {
                            console.log(error);
                            console.log(request);
                            //alert("Error: "+JSON.stringify(error) + "Linea <?= __LINE__ - 1 ?>");
            ...
            const updateTools = () =>{   
                ...
                //cambio id en botón add img
                if(btn_img_view){
                    btn_img_view.setAttribute('id', 'imgGetIn_view');
                }
            
                //edit poster set onclick
                if (!btn_edit_post.hasAttribute('onclick="edit_color(\'view\')"')) { // Si no tiene el atributo onclick, añádelo `
	 ...
	 var currentTab = "IMAGE";
	        ...
	        function uploadMedia(input) {
	            if (input.files && input.files[0]) {
	                ...
	                //	mediaType = 'VIDEO';
	                    ...
	                    //alert('Tipo de Archivo no valido, tipos aceptados: IMAGEN or VIDEO');
	                    ...
	                    $.ajax({
	                            ...
	                            xhr.upload.addEventListener("progress", function(evt) {
	                                if (evt.lengthComputable) {
	                                    ...
	                                    if (percentComplete >= 100) {
	                                        ...
	                                        //setTimeout(
	                                        //  function(){
	                                        //	console.log("Subida 100% voy a cerrar modal despues de 1.5 sec");
	                                        //    $("#uploadMediaModal").modal("hide");
	                                        //  }, 1500);
	                                    }
	                                }
	                        ...
	                        success: function(response) {
	                            if (response.success == 'Y') {
	                                ...
	                                //setTimeout(
	                                //  function(){
	                                //	console.log("Success voy a cerrar modal despues de 1.5 sec");
	                                //    $("#uploadMediaModal").modal("hide");
	                                //  }, 1500);
	                            } else {
	                        ...
	                        error: function(request, error) {
	                            ...
	                            setTimeout(
	                                function() {
	                                    console.log("Error: voy a cerrar modal despues de 1.5 sec");
	                                    $("#uploadMediaModal").modal("hide");
	                                }, 1500);
	                        }
	                    });
	        ...
	        function makeDiv(url, id, type, media) {
	            ...
	            var innerDiv = '<div id="newDiv-' + id + '" name="newDiv-' + id + '" media-type="' + type +
	                '" class="cards col-3 mt-3 mx-2 p-0">' +
	                '<div class=" options d-flex col-12 justify-content-end p-0"' + playVideo + '>' +
	                '<input type="checkbox" class="selecter mt-2 mr-2" id="checkMedia_' + id + '" name="' + id + '">' +
	        ...
	        //Selected Media
	        function selectInputsMedia() {
	            console.log('selectInputsMedia');
	            let inputsMedia = document.querySelectorAll('.selecter');
	            console.log('selectInputsMedia Total: ' + document.querySelectorAll('.selecter').length);
	        ...
	        function selectMedia(element) {
	            // element.removeEventListener("change", () =>{}); // Fallo
