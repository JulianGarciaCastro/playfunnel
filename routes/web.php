...
*/
    ...
    Route::get('actions', function (Request $request) {
        ...
        return View::make('step3', compact('project', 'projectLibs', 'cuePoints', 'library', 'user'));
    ...
    Route::get('embed', function (Request $request) {
        ...
        $userStatus = $user->status == 'ACTIVE' ? true : false;
    ...
    Route::get('/crm', [App\Http\Controllers\CrmController::class, 'index'])->middleware(['verified'])->name('crm');
    Route::post('crm-CustomerByProjectId', [App\Http\Controllers\CrmController::class, 'getCustomersByProject'])->middleware(['verified'])->name('getCustomersByProject');
    Route::post('crm-CustomerById', [App\Http\Controllers\CrmController::class, 'getCutomerById'])->middleware(['verified'])->name('getCutomerById');
